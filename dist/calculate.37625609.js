...
var numberFormatter = function numberFormatter(number) {
  ...
  var keepNumber = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
...
var basicFunctions = {
  ...
  calcMonthlyLoanPayment: calcMonthlyLoanPayment,
...
var growAgainstInflation = basicFunctions.growAgainstInflation;
var calcMonthlyLoanPayment = basicFunctions.calcMonthlyLoanPayment; //home creator takes all the required variables related to a home purchase and saves them as an object.  This is a factory function for home objects
...
var homeCreator = function homeCreator(_number, _yearPurchased, _yearSold, _originalValue) {
  ...
  var _renting = arguments.length > 10 && arguments[10] !== undefined ? arguments[10] : false;

  var _monthlyRent = arguments.length > 11 && arguments[11] !== undefined ? arguments[11] : 0;
...
var kidCreator = function kidCreator() {
  ...
  var _dayCareCost = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;

  var _collegeCost = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 30000;
  ...
  return {
    ...
    yearlyCost: function yearlyCost(seekingYear) {
      ...
      if (seekingYear < this._yearBorn) {
        cost = 0; //if seeking year occurs between age 0 and 4, enter this section
      } else if (seekingYear - this._yearBorn < 4) {
        //cost is regular monthly cost + daycare cost (which can be zero)
        cost = (monthlyCost + this._dayCareCost) * 12 - taxCredit; //This section is for kids aged 4-18
      } else if (seekingYear - this._yearBorn <= 18) {
        cost = monthlyCost * 12 - taxCredit; //Seeking year falls within college years
      } else if (seekingYear - this._yearBorn > 18 && seekingYear - this._yearBorn < 23) {
        cost = this._collegeCost - taxCredit; //Kid has left the nest, no cost
...
var retirementExports = {
  balanceYearOfCashFlow: balanceYearOfCashFlow,
...
var loanCreator = function loanCreator(_number, _yearOriginated, _amount, _interestRate, _length, _cashInflow) {
  return {
    _number: _number,
    _yearOriginated: _yearOriginated,
    _amount: _amount,
    _interestRate: _interestRate,
    _length: _length,
    _cashInflow: _cashInflow,
    monthlyPayment: function monthlyPayment(seekingYear) {
      var monthlyPayment = 0; //start by making sure the year being passed to method is reasonable
...
var returnAnnualLoanCost = function returnAnnualLoanCost(year) {
  ...
  if (loans.length > 0) {
    ...
    var annualCost = annualLoanCostValues.reduce(function (previousValue, currentValue) {
      return previousValue + currentValue;
    });
    return annualCost;
  } else {
...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : (global = global || self, global.Chart = factory());
})(this, function () {
  'use strict';
...
},{}],"calculate.js":[function(require,module,exports) {
"use strict";

var _ChartBundle = _interopRequireDefault(require("./Chart.bundle.js"));
...
var numberFormatter = basicFunctions.numberFormatter;

var regSpending = require('./regularcost.js');
...
var balanceYearOfCashFlow = retirementImports.balanceYearOfCashFlow;
...
function bigCalc() {
  ...
  nets.reduce(function (previousValue, currentValue, i) {
    return cumulativeNet[i] = previousValue + currentValue;
  }, 0);
  regAccountTotals.forEach(function (element) {
    netWorth.push(element);
  });
  retirementAccountTotals.forEach(function (element, index) {
    netWorth[index] += element;
  });

  if (preTaxSalaries[0].length == 1) {
    preTaxSalaries.forEach(function (element) {
  ...
  _ChartBundle.default.defaults.global.tooltips.callbacks.label = function (tooltipItem) {
    return '$' + tooltipItem.yLabel.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
  };

  _ChartBundle.default.scaleService.updateScaleDefaults('linear', {
    ticks: {
      beginAtZero: true,
...
},{}]},{},["../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","calculate.js"], null)
//# sourceMappingURL=/calculate.37625609.js.map